        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white leading-tight">
              LEARN IN A REAL CLASSROOM. <br className="hidden sm:block" />
              <span className="text-yellow-400">BUILD REAL SKILLS.</span>
            </h2>
            ...
            <Link to="/enrollment" tabIndex={-1}>
              <Button size="lg" className="px-10 bg-yellow-400 text-yellow-950 hover:bg-yellow-500 shadow-lg text-lg">
                ENROLL NOW
              </Button>
            </Link>
          </motion.div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-4 mt-8">
                <img 
                  ...
                  className="rounded-3xl w-full h-64 object-cover shadow-lg border border-green-800"
                />
                <div className="bg-green-800 rounded-3xl h-48 flex items-center justify-center p-6 text-center border border-green-700">
                  <div>
                    <div className="text-4xl font-bold text-white mb-2">100%</div>
                    <div className="text-green-200 font-medium uppercase tracking-wider text-sm">Practical</div>
                  </div>
                </div>
              </div>
            </div>
